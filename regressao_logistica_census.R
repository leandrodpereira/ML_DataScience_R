...
#Preprocessamento full = 0.8508 
#Preprocessamento (categóricos) = 0.8404
#Preprocessamento (escalonamento) = 0.8404 (apenas income com encode) 
#Sem Preprocessamento = 0.8492  (apenas income com encode) 