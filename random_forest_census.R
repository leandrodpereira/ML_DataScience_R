...
#Conferindo se todos registros foram convertidas
base[is.na(base$sex)]
...
set.seed(1)
classificador = randomForest(x = base_treinamento[-15], y = base_treinamento$income, ntree = 15)
previsao = predict(classificador, newdata = base_teste[-15])
...
#Preprocessamento  = 0.8534
#Preprocessamento (categóricos) = 0.853
#Preprocessamento (escalonamento) = 0.8563 
#Sem Preprocessamento = 0.8504